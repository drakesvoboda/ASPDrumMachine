    ...
    return {
        ...
        saveMachine: function() {
            $http.post("/Ajax/SaveMachine", {
                ...
                console.log(response), console.log(response), $http.post("/Ajax/SaveMachine", {
                    name: "Added 1",
                    gridLength: 15,
                    tempo: 150
                }).then(function(response2) {
                    _machineID = response2.data.id, console.log(response2), $http.post("/Ajax/SaveMachine", {
                        name: "Added 2",
                        gridLength: 12,
                        tempo: 150
                    }).then(function(response3) {
                        console.log(response3), $http.post("/Ajax/SaveMachine", {
                            machineID: _machineID,
                            name: "Update",
                            gridLength: 12,
                            tempo: 2
...
var Beat = function() {
    ...
    return addBeats(initialBeats), {
        ...
        saveRow: function(machineID, $http) {
            return this.machineID = machineID, $http.post("/Ajax/SaveRow", this).then(function(response) {
                return console.log(response), rowID = response.data.id, "Row Saved";
            });
        }
    };
};
