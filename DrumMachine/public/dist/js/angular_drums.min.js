    ...
    return {
        loadMachine: function(machineID) {
            return $http.post("/Ajax/Machine", {
                ...
                setTempo(response.data.tempo), console.log(response);
        ...
        saveMachine: function() {
            $http.post("/Ajax/SaveMachine", {
                ...
                for (var json = "", i = 0, len = _rows.length; i < len; ++i) json += _rows[i].toString();
...
var Beat = function() {
    ...
    }), _sound = new Sound(json.name, json.description, json.audiofile, player), _beats = [], _instrumentID = json.id;
    return addBeats(json.sequence), {
        getSound: function() {
            return _sound;
        },
        getBeats: function() {
...
}, Sound = function(name, description, audiofile, player) {
    var audioPlayer = audioPlayer, _name = name, _description = description, _audiofile = audiofile;
    return {
        getName: function() {
            return _name;
        },
