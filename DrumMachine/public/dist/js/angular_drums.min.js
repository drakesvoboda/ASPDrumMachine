    ...
    return {
        loadMachine: function(machineID) {
            return $http.post("/Ajax/Machine", {
                ...
                _gridLength = response.data.gridLength, _name = response.data.name, _machineID = response.data.id, 
    ...
    return {
        ...
        loadNav: function() {
            return $http.post("/Ajax/SavedMachines").then(function(response) {
                for (var i = 0, len = response.data.length; i < len; ++i) _machines.push(new MachineNavItem(response.data.id, response.data.name));
