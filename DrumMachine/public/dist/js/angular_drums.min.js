...
!function(n, e, A) {
            ...
            link: function(a, c, b, f, w) {
                ...
                function v() {
                    ...
                    if (e.isDefined(b && b.$template)) {
                        ...
                        }), (k = d.scope = b).$emit("$viewContentLoaded"), k.$eval(u);
                    } else y();
                }
    ...
    (n = e.module("ngRoute", [ "ng" ]).provider("$route", function() {
        ...
        this.when = function(a, c) {
            ...
            function p() {
                var a, b;
                return e.forEach(h, function(f, h) {
                    var q;
                    if (q = !b) {
                        var g = c.path();
                        q = f.keys;
    ...
    if (n) {
        var a = void 0 === o.createGain ? o.createGainNode() : o.createGain();
        a.gain.value = 1, a.connect(o.destination);
    }
    var i = function(e) {
        this._volume = 1, this._muted = !1, this.usingWebAudio = n, this.ctx = o, this.noAudio = r, 
        this._howls = [], this._codecs = e, this.iOSAutoEnable = !0;
    };
    i.prototype = {
        volume: function(e) {
            var o = this;
            if ((e = parseFloat(e)) >= 0 && 1 >= e) {
                ...
                for (var r in o._howls) if (o._howls.hasOwnProperty(r) && !1 === o._howls[r]._webAudio) for (var t = 0; t < o._howls[r]._audioNode.length; t++) o._howls[r]._audioNode[t].volume = o._howls[r]._volume * o._volume;
                return o;
            }
        ...
        _setMuted: function(e) {
            ...
            for (var r in o._howls) if (o._howls.hasOwnProperty(r) && !1 === o._howls[r]._webAudio) for (var t = 0; t < o._howls[r]._audioNode.length; t++) o._howls[r]._audioNode[t].muted = e;
        },
        codecs: function(e) {
        ...
        _enableiOSAudio: function() {
            ...
            if (!o || !e._iOSEnabled && /iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                e._iOSEnabled = !1;
                var n = function() {
                    var r = o.createBuffer(1, 1, 22050), t = o.createBufferSource();
                    t.buffer = r, t.connect(o.destination), void 0 === t.start ? t.noteOn(0) : t.start(0), 
                    setTimeout(function() {
                        (t.playbackState === t.PLAYING_STATE || t.playbackState === t.FINISHED_STATE) && (e._iOSEnabled = !0, 
                        e.iOSAutoEnable = !1, window.removeEventListener("touchend", n, !1));
                    }, 0);
                };
    ...
    var l = new i(d), f = function(e) {
        var r = this;
        r._autoplay = e.autoplay || !1, r._buffer = e.buffer || !1, r._duration = e.duration || 0, 
        r._format = e.format || null, r._loop = e.loop || !1, r._loaded = !1, r._sprite = e.sprite || {}, 
        r._src = e.src || "", r._pos3d = e.pos3d || [ 0, 0, -.5 ], r._volume = void 0 !== e.volume ? e.volume : 1, 
        r._urls = e.urls || [], r._rate = e.rate || 1, r._model = e.model || null, r._onload = [ e.onload || function() {} ], 
        r._onloaderror = [ e.onloaderror || function() {} ], r._onend = [ e.onend || function() {} ], 
        r._onpause = [ e.onpause || function() {} ], r._onplay = [ e.onplay || function() {} ], 
        r._onendTimer = [], r._webAudio = n && !r._buffer, r._audioNode = [], r._webAudio && r._setupAudioNode(), 
        void 0 !== o && o && l.iOSAutoEnable && l._enableiOSAudio(), l._howls.push(r), r.load();
    };
    if (f.prototype = {
        load: function() {
            var e = this, o = null;
            if (r) e.on("loaderror", new Error("No audio support.")); else {
                for (var n = 0; n < e._urls.length; n++) {
                    var t, a;
                    if (e._format) t = e._format; else {
                        if (a = e._urls[n], (t = /^data:audio\/([^;,]+);/i.exec(a)) || (t = /\.([^.]+)$/.exec(a.split("?", 1)[0])), 
                        !t) return void e.on("loaderror", new Error("Could not extract format from passed URLs, please add format parameter."));
                        t = t[1].toLowerCase();
                    }
                    if (d[t]) {
                        o = e._urls[n];
                ...
                if (o) {
                    if (e._src = o, e._webAudio) s(e, o); else {
                        var u = new Audio();
                ...
                e.on("loaderror", new Error("No codec support for selected audio sources."));
            }
        },
        urls: function(e) {
            var o = this;
            return e ? (o.stop(), o._urls = "string" == typeof e ? [ e ] : e, o._loaded = !1, 
            o.load(), o) : o._urls;
        },
        play: function(e, n) {
            var r = this;
            return "function" == typeof e && (n = e), e && "function" != typeof e || (e = "_default"), 
            r._loaded ? r._sprite[e] ? (r._inactiveNode(function(t) {
                t._sprite = e;
                var a = t._pos > 0 ? t._pos : r._sprite[e][0] / 1e3, i = 0;
                r._webAudio ? (i = r._sprite[e][1] / 1e3 - t._pos, t._pos > 0 && (a = r._sprite[e][0] / 1e3 + a)) : i = r._sprite[e][1] / 1e3 - (a - r._sprite[e][0] / 1e3);
                var u, d = !(!r._loop && !r._sprite[e][2]), f = "string" == typeof n ? n : Math.round(Date.now() * Math.random()) + "";
                if (function() {
                    var o = {
                        id: f,
                        sprite: e,
                    ...
                    u = setTimeout(function() {
                        !r._webAudio && d && r.stop(o.id).play(e, o.id), r._webAudio && !d && (r._nodeById(o.id).paused = !0, 
                        r._nodeById(o.id)._pos = 0, r._clearEndTimer(o.id)), r._webAudio || d || r.stop(o.id), 
                        r.on("end", f);
                    ...
                    var s = r._sprite[e][0] / 1e3, _ = r._sprite[e][1] / 1e3;
                    t.id = f, t.paused = !1, p(r, [ d, s, _ ], f), r._playStart = o.currentTime, t.gain.value = r._volume, 
                    void 0 === t.bufferSource.start ? d ? t.bufferSource.noteGrainOn(0, a, 86400) : t.bufferSource.noteGrainOn(0, a, i) : d ? t.bufferSource.start(0, a, 86400) : t.bufferSource.start(0, a, i);
                } else {
                    if (4 !== t.readyState && (t.readyState || !navigator.isCocoonJS)) return r._clearEndTimer(f), 
                    function() {
                        var o = r, a = e, i = n, u = t, d = function() {
                            o.play(a, i), u.removeEventListener("canplaythrough", d, !1);
                        };
                        u.addEventListener("canplaythrough", d, !1);
                    }(), r;
                    t.readyState = 4, t.id = f, t.currentTime = a, t.muted = l._muted || t.muted, t.volume = r._volume * l.volume(), 
                    setTimeout(function() {
                        t.play();
                    }, 0);
                }
        ...
        pos: function(e, n) {
            ...
            if (e >= 0) return r;
            for (var a = 0; a < r._audioNode.length; a++) if (r._audioNode[a].paused && 4 === r._audioNode[a].readyState) return r._webAudio ? r._audioNode[a]._pos : r._audioNode[a].currentTime;
        },
        ...
        _nodeById: function(e) {
            for (var o = this, n = o._audioNode[0], r = 0; r < o._audioNode.length; r++) if (o._audioNode[r].id === e) {
                n = o._audioNode[r];
                break;
            }
            return n;
        ...
        _inactiveNode: function(e) {
            for (var o = this, n = null, r = 0; r < o._audioNode.length; r++) if (o._audioNode[r].paused && 4 === o._audioNode[r].readyState) {
                e(o._audioNode[r]), n = !0;
                break;
            }
            if (o._drainPool(), !n) {
                var t;
                if (o._webAudio) t = o._setupAudioNode(), e(t); else {
        ...
        _drainPool: function() {
            ...
            for (e = o._audioNode.length - 1; e >= 0 && !(5 >= n); e--) o._audioNode[e].paused && (o._webAudio && o._audioNode[e].disconnect(0), 
            n--, o._audioNode.splice(e, 1));
        },
        _clearEndTimer: function(e) {
            for (var o = this, n = -1, r = 0; r < o._onendTimer.length; r++) if (o._onendTimer[r].id === e) {
                n = r;
                break;
            }
        ...
        _setupAudioNode: function() {
            ...
            return n[r] = void 0 === o.createGain ? o.createGainNode() : o.createGain(), n[r].gain.value = e._volume, 
            n[r].paused = !0, n[r]._pos = 0, n[r].readyState = 4, n[r].connect(a), n[r].panner = o.createPanner(), 
            n[r].panner.panningModel = e._model || "equalpower", n[r].panner.setPosition(e._pos3d[0], e._pos3d[1], e._pos3d[2]), 
            n[r].panner.connect(n[r]), n[r];
        },
        on: function(e, o) {
            var n = this, r = n["_on" + e];
            if ("function" == typeof o) r.push(o); else for (var t = 0; t < r.length; t++) o ? r[t].call(n, o) : r[t].call(n);
            return n;
        },
        off: function(e, o) {
            var n = this, r = n["_on" + e];
            if (o) {
                for (var t = 0; t < r.length; t++) if (o === r[t]) {
                    r.splice(t, 1);
                    break;
                }
            } else n["_on" + e] = [];
        ...
        unload: function() {
            for (var o = this, n = o._audioNode, r = 0; r < o._audioNode.length; r++) n[r].paused || (o.stop(n[r].id), 
            o.on("end", n[r].id)), o._webAudio ? n[r].disconnect(0) : n[r].src = "";
        ...
        if (/^data:[^;]+;base64,/.test(n)) {
            ...
            i.open("GET", n, !0), i.responseType = "arraybuffer", i.onload = function() {
                ...
                o._webAudio && (o._buffer = !0, o._webAudio = !1, o._audioNode = [], delete o._gainNode, 
                delete e[n], o.load());
            };
            try {
                i.send();
        ...
        var a = n._nodeById(t);
        a.bufferSource = o.createBufferSource(), a.bufferSource.buffer = e[n._src], a.bufferSource.connect(a.panner), 
        a.bufferSource.loop = r[0], r[0] && (a.bufferSource.loopStart = r[1], a.bufferSource.loopEnd = r[1] + r[2]), 
    ...
    }), "undefined" != typeof exports && (exports.Howler = l, exports.Howl = f), "undefined" != typeof window && (window.Howler = l, 
    window.Howl = f);
}();
...
app.run([ "drumMachine", "machineNav", "$q", "$rootScope", "$timeout", function(drumMachine, machineNav, $q, $rootScope, $timeout) {
    $rootScope.loading = !0, drumMachine.loadMachine(1).then(function(result) {
    ...
    $scope.lock = !1, $scope.playLoop = function() {
        $scope.lock || ($scope.machine.play(), $scope.fade_msg_play = !0, $scope.lock = !0);
        ...
        $scope.loading = !0, $scope.machine.loadMachine(id).then(function(result) {
            $scope.loading = !1;
        });
    ...
    var _playing = !1, _currentBeat = 0, _delay = 100, _gridLength = 16, _tempo = 120, _timers = timerQueue, _rows = [], _name = "New Machine", _machineID = 0;
    return {
        loadMachine: function(machineID) {
            if (_machineID = machineID, _rows = [], 0 == _machineID) {
                _tempo = 120, _delay = 100, _gridLength = 16, _name = "New Machine";
                var dfd = $q.defer();
                return dfd.resolve(), dfd.promise;
            }
            return $http.post("/Ajax/Machine", {
                machineID: machineID
            }).then(function(response) {
                _gridLength = response.data.gridLength, _name = response.data.name, _tempo = response.data.tempo, 
                setTempo(response.data.tempo);
                for (var i = 0, len = response.data.instruments.length; i < len; ++i) {
                    var json = response.data.instruments[i], player = new Howl({
                        urls: [ "/sounds/" + json.sound.audiofile ]
                    }), sound = new Sound(json.sound.id, json.sound.name, json.sound.description, json.sound.audiofile, player);
        ...
        addNewRow: function(newRow) {
            var player = new Howl({
                urls: [ newRow.file.data ]
            }), sound = new Sound(0, newRow.name, "", newRow.file.name, player);
            _rows.push(new Instrument(0, Array(_gridLength + 1).join("0"), sound));
        },
        saveMachine: function() {
            return $http.post("/Ajax/SaveMachine", {
                ...
                for (var json = [], i = 0, len = _rows.length; i < len; ++i) {
                    var row = _rows[i];
    ...
    return {
        ...
        loadNav: function() {
            return _machines = [], $http.post("/Ajax/SavedMachines").then(function(response) {
                for (var i = 0, len = response.data.length; i < len; ++i) _machines.push(new MachineNavItem(response.data[i].id, response.data[i].name));
                return _machines.push(new MachineNavItem(0, "New Machine")), "Nav Loaded";
            });
        }
    };
});
...
}, Instrument = function(id, sequence, sound) {
    function addBeats(sequence) {
        for (var i = 0; i < sequence.length; i++) _beats.push(new Beat()), "1" == sequence[i] && _beats[i].activate();
    }
    var _sound = sound, _beats = [], _instrumentID = id;
    return addBeats(sequence), {
        getSound: function() {
            return _sound;
        },
        getBeats: function() {
        ...
        addBeats: addBeats,
        reset: function() {
            for (var i = 0; i < _beats.length; i++) _beats[i].deactivate();
        },
        playSound: function(index) {
            return !!_beats[index].isActive() && _sound.play();
        },
        toString: function() {
            var obj = {
                sequence: _beats.map(function(x) {
...
}, MachineNavItem = function(id, name) {
    var _machineID = id, _name = name;
    return {
        getID: function() {
            return _machineID;
        },
...
}, Sound = function(id, name, description, audiofile, player) {
    var audioPlayer = player, _name = name, _description = description, _audiofile = audiofile, _soundID = id;
    return {
        getName: function() {
            return _name;
        },
        getDescrption: function() {
            return _description;
        },
